...
class AmbilReportTasl3 extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String daritanggal,sampaitanggal,terpilih;
    AmbilReportTasl3(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = ctx.getResources().getString(R.string.xyz)+"mutasisaldo/";
