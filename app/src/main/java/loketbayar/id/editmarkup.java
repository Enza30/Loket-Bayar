...
public class editmarkup extends AppCompatActivity {
    private EditText etuppln,etuppdam,etuptagihan,etuptopup,etreferral,etkodeloket;
    private Button btSubmit;
    private String uppln,uppdam,uptagihan,uptopup,referral,responseCode, message,username,datauser,
            password,kodeloket,pln,pdam,tagihan,topup;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_editmarkup);
        ...
        new editmarkup.AmbilPlnTasks2(editmarkup.this).execute(getString(R.string.link)+"apis/android/data/markup");
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(adaInternet()){
                    String username = boyprefs.getString("username", "");
                    String password = boyprefs.getString("password", "");
                    new LoginTask(editmarkup.this).execute("login", username, password);
                }
                else{
                    Toast.makeText(editmarkup.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                }
            }
        });
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                uppdam=etuppdam.getText().toString();
                uptagihan=etuptagihan.getText().toString();
                uptopup=etuptopup.getText().toString();
                if(uppln.isEmpty()){
                    Toast.makeText(editmarkup.this, "Masukkan Mark Up PLN", Toast.LENGTH_SHORT).show();
                }
                else if(uppdam.isEmpty()){
                    Toast.makeText(editmarkup.this, "Masukkan Mark Up PDAM", Toast.LENGTH_SHORT).show();
                }
                else if(uptagihan.isEmpty()){
                    Toast.makeText(editmarkup.this, "Masukkan Mark Up Tagihan", Toast.LENGTH_SHORT).show();
                }
                else if(uptopup.isEmpty()){
                    Toast.makeText(editmarkup.this, "Masukkan Mark Up Topup", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(adaInternet()) {
                       new editmarkup.AmbilPlnTasks3(editmarkup.this).execute(getString(R.string.link)+"apis/android/user/edit-markup");}
                    else{
                        Toast.makeText(editmarkup.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public class AmbilPlnTasks2 extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                jsonRequest.put("kode_loket", kode_loket.get(0));
        ...
        protected void onPostExecute(String s) {
            ...
            if (responseCode.equalsIgnoreCase("00")) {
                try {
                    JSONObject mainJSONObj = new JSONObject(s);
                    referral = mainJSONObj.getString("referral");
                    pln = mainJSONObj.getString("pln");
                    pdam = mainJSONObj.getString("pdam");
                    tagihan = mainJSONObj.getString("tagihan");
                    topup = mainJSONObj.getString("topup");
                ...
                etuppln.setText(pln);
                etuppdam.setText(pdam);
                etuptagihan.setText(tagihan);
                etuptopup.setText(topup);

            }
            else {
                etreferral.setEnabled(false);
                etuppln.setEnabled(false);
                etuppdam.setEnabled(false);
                etuptagihan.setEnabled(false);
                etuptopup.setEnabled(false);
    ...
    public class AmbilPlnTasks3 extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                jsonRequest.put("pln", uppln);
                jsonRequest.put("pdam", uppdam);
                jsonRequest.put("tagihan", uptagihan);
                jsonRequest.put("topup", uptopup);
