...
class GantiPasswordBundle {
   private Context ctx;
   private SharedPreferences boyprefs;
   private Dialog load;
    GantiPasswordBundle(Context ctx, Dialog load) {
        this.ctx = ctx;
        this.load = load;
    }


    void requestAction(String usernames, String passwords,String passbaru,String konfirmpas,String POST_ORDER) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, POST_ORDER, ServerResponse -> {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(ctx.getString(R.string.password), passwords);
