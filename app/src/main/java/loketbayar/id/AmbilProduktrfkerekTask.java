...
class AmbilProduktrfkerekTask extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String results;
    AmbilProduktrfkerekTask(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            if(result.contains("dataproduk")){
                ...
                transferkerek.kode_produk_biller=kode_produk_biller.get(0);
                transferkerek.harga_biller=harga_biller.get(0);
                transferkerek.admin_biller=admin_biller.get(0);
                if(fee_ca.isEmpty()){
                    transferkerek.fee_ca="0";
                    ...
                    transferkerek.fee_ca=fee_ca.get(0);
                    transferkerek.fee_sub_ca=fee_sub_ca.get(0);
                    transferkerek.fee_sub_ca_1=fee_sub_ca_1.get(0);
                    transferkerek.fee_sub_ca_2=fee_sub_ca_2.get(0);
                    transferkerek.fee_sub_ca_3=fee_sub_ca_3.get(0);
                }
                transferkerek.fee_app=fee_app.get(0);
                transferkerek.fee_biller=fee_biller.get(0);
                transferkerek.dataproduk=results;
                runThread();
