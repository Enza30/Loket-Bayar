...
public class travel extends AppCompatActivity implements PrintingCallback {
    Printing printing;
...
//    private Button btPrint;
  ...
  //      ivPrint = findViewById(R.id.ivPrint);
        ...
        tvJuduls.setText("TRAVEL");
        username=boyprefs.getString("username","");
        password=boyprefs.getString("password","");
        new AmbilSaldoTask(travel.this,tvSaldo).execute("ambil",username,password,kode_loket.get(0));
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new LoginTask(travel.this).execute("login", username, password);
                }else{
                    Toast.makeText(travel.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                } }
        });
