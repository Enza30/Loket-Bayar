...
class AmbilProdukBpjsTask extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String results;
    AmbilProdukBpjsTask(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            if(result.contains("dataproduk")){
                ...
                Bpjs.kode_produk_biller=kode_produk_biller.get(0);
                Bpjs.harga_biller=harga_biller.get(0);
                Bpjs.admin_biller=admin_biller.get(0);
                ...
                if(fee_ca.isEmpty()){
                    ...
                    Bpjs.fee_ca=fee_ca.get(0);
                    Bpjs.fee_sub_ca=fee_sub_ca.get(0);
                    Bpjs.fee_sub_ca_1=fee_sub_ca_1.get(0);
                    Bpjs.fee_sub_ca_2=fee_sub_ca_2.get(0);
                    Bpjs.fee_sub_ca_3=fee_sub_ca_3.get(0);
                }
                Bpjs.fee_app=fee_app.get(0);
                Bpjs.fee_biller=fee_biller.get(0);
                Bpjs.dataproduk=results;
                runThread();
