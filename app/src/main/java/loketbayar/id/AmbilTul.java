...
class AmbilTul extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String daritanggal,sampaitanggal,terpilih;
    AmbilTul(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = ctx.getResources().getString(R.string.xyz)+"ambiltul/";
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    ctx.startActivity(new Intent(ctx,HasilTul.class));
                    ((Activity)ctx).finish();
