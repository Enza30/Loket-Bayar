...
class AmbilProdukTaskPDAM extends AsyncTask<String, Void, String> {
   private Context ctx;
    private String results;
    AmbilProdukTaskPDAM(Context ctx) {
        this.ctx = ctx;
    }
       ...
       // Toast.makeText(ctx, result, Toast.LENGTH_SHORT).show();
        try {
           if(result.contains("dataproduk")){
               ...
               Pdam.kode_produk_biller=kode_produk_biller.get(0);
               Pdam.kode_produk_biller=kode_produk_biller.get(0);
...
//                       }
  //                 });
    //               dialog.show();
      //         }
        //       else{
          //         Pdam.fee_sub_ca=fee_sub_ca.get(0);
            //       Pdam.fee_sub_ca=fee_sub_ca.get(0);
              // }
               if(fee_ca.isEmpty()){
                   Pdam.fee_ca="0";
                   ...
                   Pdam.fee_ca=fee_ca.get(0);
                   Pdam.fee_sub_ca=fee_sub_ca.get(0);
                   Pdam.fee_sub_ca_1=fee_sub_ca_1.get(0);
                   Pdam.fee_sub_ca_2=fee_sub_ca_2.get(0);
                   Pdam.fee_sub_ca_3=fee_sub_ca_3.get(0);
               }

               Pdam.dataproduk=results;
