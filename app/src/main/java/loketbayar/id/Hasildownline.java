...
public class Hasildownline extends AppCompatActivity implements PrintingCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasil_downline);
        ...
        DownlineAdapter boyiadapter2=new DownlineAdapter(Hasildownline.this,kode_produk,kategori2,inputs,total,tagihan,admin,denda,jumlah_transaksi,
 ...
 //           float fee= ttl-hrglkt;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Hasildownline.this, Laporan.class));
        finish();
    }
