...
public class kasir extends AppCompatActivity implements PrintingCallback {
    Printing printing;
...
//    private Button btPrint;
  ...
  //      ivPrint = findViewById(R.id.ivPrint);
        ...
        tvJuduls.setText("KASIR");
        username=boyprefs.getString("username","");
        password=boyprefs.getString("password","");
        new AmbilSaldoTask(kasir.this,tvSaldo).execute("ambil",username,password,kode_loket.get(0));
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new LoginTask(kasir.this).execute("login", username, password);
                }else{
                    Toast.makeText(kasir.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                } }
        });
