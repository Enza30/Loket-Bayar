...
class AmbilReportTasl4 extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String daritanggal,sampaitanggal,terpilih;
    AmbilReportTasl4(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = ctx.getResources().getString(R.string.xyz)+"ambilreport2/";
        ...
        new Thread() {
            public void run() {
                ...
                if(terpilih.equalsIgnoreCase("Laporan")){
                    ...
                    ctx.startActivity(new Intent(ctx, HasilMutasi.class));
                    ((Activity) ctx).finish();
                } else if(terpilih.equalsIgnoreCase("Mutasi Downline")) {
                    ctx.startActivity(new Intent(ctx, Hasildownline.class));
                    ((Activity) ctx).finish();
                }
