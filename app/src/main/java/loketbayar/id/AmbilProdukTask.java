...
class AmbilProdukTask extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String results;
    AmbilProdukTask(Context ctx) {
        this.ctx = ctx;
    }
      ...
      //                  }
        //            });
          //          dialog.show();
            //    }
    //            else {
     //               Pln.fee_sub_ca = fee_sub_ca.get(0);
      //          }
                if (fee_ca.isEmpty()) {
                    Pln.fee_ca = "0";
                    Dialog dialog = new Dialog(ctx);
                    ...
                    Pln.fee_ca = fee_ca.get(0);
                    Pln.fee_sub_ca = fee_sub_ca.get(0);
                    Pln.fee_sub_ca_1 = fee_sub_ca_1.get(0);
                    Pln.fee_sub_ca_2 = fee_sub_ca_2.get(0);
                    Pln.fee_sub_ca_3 = fee_sub_ca_3.get(0);
                }

                Pln.admin_biller = admin_biller.get(0);
                Pln.fee_app = fee_app.get(0);
                Pln.fee_biller = fee_biller.get(0);
                Pln.dataproduk = results;
                runThread();
