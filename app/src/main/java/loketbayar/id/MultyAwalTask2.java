...
class MultyAwalTask2 extends AsyncTask<String, Void, String> {
   private Context ctx;
    private String username,password,kodeloket;
    MultyAwalTask2(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = ctx.getResources().getString(R.string.xyz)+"asktoin6sec/";
