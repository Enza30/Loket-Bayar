...
public class ka extends AppCompatActivity implements PrintingCallback {
    Printing printing;
...
//    private Button btPrint;
  ...
  //      ivPrint = findViewById(R.id.ivPrint);
        ...
        tvJuduls.setText("KERETA API");
        username=boyprefs.getString("username","");
        password=boyprefs.getString("password","");
        new AmbilSaldoTask(ka.this,tvSaldo).execute("ambil",username,password,kode_loket.get(0));
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new LoginTask(ka.this).execute("login", username, password);
                }else {
                    Toast.makeText(ka.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                } }
        });
