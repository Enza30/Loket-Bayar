...
public class DownlineAdapter extends RecyclerView.Adapter<DownlineAdapter.CustomViewHolder> implements PrintingCallback {
    ...
    private int no = 0;
    DownlineAdapter(Activity context, ArrayList<String> kode_produk, ArrayList<String> kategori2, ArrayList<String> inputs,
    ...
    @NonNull
    @Override
    public DownlineAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final DownlineAdapter.CustomViewHolder holder, @SuppressLint("RecyclerView") final int position) {
...
// User Define Method
            ...
            public void onClick(View view) {
                if (kategori2.get(position).equals("PDAM")) {
                    ...
                    sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Pembayaran Tagihan " + kode_produk.get(position) +
                            "a.n " + namanya);
                   ...
                   String s = "STRUK PEMBAYARAN TAGIHAN\n" + kode_produk.get(position) + " (CU)" + "\n\n" +
                    ...
                    Intent sharingIntent = new Intent(Intent.ACTION_SEND);
                    sharingIntent.setType("text/plain");
                    sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "TRANSFER KE REKENING " +
                            "NO REKENING : " + inputs.get(position));
                    sharingIntent.putExtra(Intent.EXTRA_TEXT, s);
                    context.startActivity(Intent.createChooser(sharingIntent, "Share text via"));
                }
                    ...
                    if (kode_produk.get(position).equals("Tagihan Listrik")) {
                        ...
                        Intent sharingIntent = new Intent(Intent.ACTION_SEND);
                        sharingIntent.setType("text/plain");
                        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Pembayaran Tagihan Listrik " + "a.n " + namanya);
                        sharingIntent.putExtra(Intent.EXTRA_TEXT, s);
                        context.startActivity(Intent.createChooser(sharingIntent, "Share text via"));
                    }
                    else if (kode_produk.get(position).equals("Token Listrik")) {
                        ...
                        Intent sharingIntent = new Intent(Intent.ACTION_SEND);
                        sharingIntent.setType("text/plain");
                        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "Pembayaran Tagihan BPJS KETENAGAKERJAAN " +
                                "a.n " + namanya);
                        sharingIntent.putExtra(Intent.EXTRA_TEXT, s);
                        context.startActivity(Intent.createChooser(sharingIntent, "Share text via"));
                    }
