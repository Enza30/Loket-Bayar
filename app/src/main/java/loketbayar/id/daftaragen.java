...
public class daftaragen extends AppCompatActivity {
    ...
    private String uppln,uppdam,uptagihan,uptopup,referral,responseCode, message,username,datauser,password,kodeloket;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(adaInternet()){
                    String username = boyprefs.getString("username", "");
                    String password = boyprefs.getString("password", "");
                    new LoginTask(daftaragen.this).execute("login", username, password);
                }
                else{
                    Toast.makeText(daftaragen.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                }
            }
        });
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                kodeloket=etkodeloket.getText().toString();
                if(referral.isEmpty()){
                    Toast.makeText(daftaragen.this, "Masukkan Kode Referral Anda", Toast.LENGTH_SHORT).show();
                }
                else if(uppln.isEmpty()){
                    Toast.makeText(daftaragen.this, "Masukkan Mark Up PLN", Toast.LENGTH_SHORT).show();
                }
                else if(uppdam.isEmpty()){
                    Toast.makeText(daftaragen.this, "Masukkan Mark Up PDAM", Toast.LENGTH_SHORT).show();
                }
                else if(uptagihan.isEmpty()){
                    Toast.makeText(daftaragen.this, "Masukkan Mark Up Tagihan", Toast.LENGTH_SHORT).show();
                }
                else if(uptopup.isEmpty()){
                    Toast.makeText(daftaragen.this, "Masukkan Mark Up Topup", Toast.LENGTH_SHORT).show();
                }
                else{
                    if(adaInternet()) {
                       new daftaragen.AmbilPlnTasks2(daftaragen.this).execute(getString(R.string.link)+"apis/android/user/agen");}
                    else{
                        Toast.makeText(daftaragen.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public class AmbilPlnTasks2 extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
         ...
         //       jsonRequest.put("kodeloket", kodeloket);
