...
class AmbilProdukTaskTelkom extends AsyncTask<String, Void, String> {
   private Context ctx;
    private String results;
    AmbilProdukTaskTelkom(Context ctx) {
        this.ctx = ctx;
    }
       ...
       // Toast.makeText(ctx, result, Toast.LENGTH_SHORT).show();
        try {
           if(result.contains("dataproduk")){
               ...
               Pln.kode_produk_biller=kode_produk_biller.get(0);
               Pln.harga_biller=harga_biller.get(0);
               Telkom.kode_produk_biller=kode_produk_biller.get(0);
               Telkom.harga_biller=harga_biller.get(0);
               ...
               if(fee_ca.isEmpty()){
                   ...
                   Telkom.fee_ca=fee_ca.get(0);
                   Telkom.fee_sub_ca=fee_sub_ca.get(0);
                   Telkom.fee_sub_ca_1=fee_sub_ca_1.get(0);
                   Telkom.fee_sub_ca_2=fee_sub_ca_2.get(0);
                   Telkom.fee_sub_ca_3=fee_sub_ca_3.get(0);
               }
               Telkom.admin_biller=admin_biller.get(0);
               Telkom.fee_app=fee_app.get(0);
               Telkom.fee_biller=fee_biller.get(0);
               Telkom.dataproduk=results;
              runThread();
