...
public class HasilTul extends AppCompatActivity implements PrintingCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PraTulAdapter boyiadapter2=new PraTulAdapter(HasilTul.this,kode_produk,alamat,inputs,daya,tagihan,gol,denda,jumlah_transaksi,
    ...
    public void onBackPressed() {
        startActivity(new Intent(HasilTul.this, Home.class));
        finish();
    }
    @Override
