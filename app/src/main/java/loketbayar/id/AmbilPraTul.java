...
class AmbilPraTul extends AsyncTask<String, Void, String> {
    private Context ctx;
    private String daritanggal,sampaitanggal,terpilih;
    AmbilPraTul(Context ctx) {
        this.ctx = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        String login_url = ctx.getResources().getString(R.string.xyz)+"ambilpratul/";
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    ctx.startActivity(new Intent(ctx,HasilPraTul.class));
                    ((Activity)ctx).finish();
