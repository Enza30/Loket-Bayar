...
public class samsatt extends AppCompatActivity implements PrintingCallback {
    Printing printing;
...
//    private Button btPrint;
  ...
  //      ivPrint = findViewById(R.id.ivPrint);
        ...
        username=boyprefs.getString("username","");
        password=boyprefs.getString("password","");
        new AmbilSaldoTask(samsatt.this,tvSaldo).execute("ambil",username,password,kode_loket.get(0));
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new LoginTask(samsatt.this).execute("login", username, password);
                }else{
                    Toast.makeText(samsatt.this, "Tidak Ada Sinyal", Toast.LENGTH_SHORT).show();
                } }
        });
